...
Coinrac Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Coinrac Core, where everyone uses
...
pay attention to for reviewers of Coinrac Core code.

General Coinrac Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Coinrac Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Coinrac Core so that they can be integrated
