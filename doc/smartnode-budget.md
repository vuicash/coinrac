...
Format: ```mngovernance prepare proposal-name url payment-count block-start coinrac-address monthly-payment-coinrac```
...
Format: ```mngovernance submit proposal-name url payment-count block-start coinrac-address monthly-payment-coinrac fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single smartnode (using coinrac.conf setup)
