...
#ifndef COINRAC_ARITH_UINT256_H
#define COINRAC_ARITH_UINT256_H
...
public:
     ...
     *
     * Coinrac only uses this "compact" format for encoding difficulty
