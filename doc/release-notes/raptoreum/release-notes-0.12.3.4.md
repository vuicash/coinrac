...
When deployed on testnet, it is required to start with a fresh data directory or call Coinrac Core with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/raptoreum/raptoreum/compare/v0.12.3.3...raptoreum:v0.12.3.4).
