/* src/config/coinrac-config.h.  Generated from coinrac-config.h.in by configure.  */
/* src/config/coinrac-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef COINRAC_CONFIG_H

#define COINRAC_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Coinrac Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Coinrac Core"
...
#define PACKAGE_BUGREPORT "https://github.com/coinrac/coinrac/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Coinrac Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Coinrac Core 1.2.15"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "coinraccore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://coinrac.org/"
