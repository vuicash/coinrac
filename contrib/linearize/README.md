# Linearize
Construct a linear, no-fork, best version of the Coinrac blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install coinrac_hash

https://github.com/coinrac/coinrac_hash
...
JSON-RPC server. Running `coinracd` or `coinrac-qt -server` will be sufficient.
...
* `input`: coinracd blocks/ directory containing blkNNNNN.dat
