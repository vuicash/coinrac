...
This document provides guidelines for internationalization of the Coinrac Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `raptoreum_en.ts` remains unchanged.
