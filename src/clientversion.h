...
#error Client version information missing: version is not defined by coinrac-config.h or in any other way
#endif
...
/**
 * coinracd-res.rc includes this file, but it cannot cope with real c++ code.
