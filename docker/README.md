...
official/supported Docker Images found at https://hub.docker.com/r/coinrac/coinracd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/coinrac/coinracd-develop/ when changing the above text**