    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  coinrac-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Coinrac in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 MAMA, 1 MAMA, 10 MAMA, 100 MAMA and 1000 MAMA -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.coinrac.org/en/stable/wallets/coinraccore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
