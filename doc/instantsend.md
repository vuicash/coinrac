...
This mechanism has been integrated into Bitcore-Node-Coinrac which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/coinrac/insight-api-coinrac#web-socket-api](https://github.com/coinrac/insight-api-coinrac#web-socket-api)
* API: [https://github.com/coinrac/insight-api-coinrac#instantsend-transactions](https://github.com/coinrac/insight-api-coinrac#instantsend-transactions)
